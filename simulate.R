...
## 固定数据目录（改成你的）
root_sine    <- "datasets_sine_csv"
root_sigmoid <- "datasets_sigmoid_csv"
root_shrink  <- "datasets_stepwise_csv"

out_root <- "results_csv"
...
write.csv(agp_sine_table,  file.path(out_root, "agp_runs_sine.csv"),   row.names = FALSE)
write.csv(agp_sig_table,   file.path(out_root, "agp_runs_sigmoid.csv"),row.names = FALSE)
write.csv(agp_shk_table,   file.path(out_root, "agp_runs_shrink.csv"), row.names = FALSE)

write.csv(bsam_sine_table, file.path(out_root, "bsam_runs_sine.csv"),   row.names = FALSE)
write.csv(bsam_sig_table,  file.path(out_root, "bsam_runs_sigmoid.csv"),row.names = FALSE)
write.csv(bsam_shk_table,  file.path(out_root, "bsam_runs_shrink.csv"), row.names = FALSE)

cat("\n已保存：\n -", file.path(out_root, "summary_all_mean_sd.csv"),
    "\n -", file.path(out_root, "agp_runs_sine.csv"),
    "\n -", file.path(out_root, "agp_runs_sigmoid.csv"),
    "\n -", file.path(out_root, "agp_runs_shrink.csv"),
    "\n -", file.path(out_root, "bsam_runs_sine.csv"),
    "\n -", file.path(out_root, "bsam_runs_sigmoid.csv"),
    "\n -", file.path(out_root, "bsam_runs_shrink.csv"), "\n")
